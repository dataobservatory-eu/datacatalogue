...
| Term | Description |
|----------------|--------------------------------------------------------|
| `ISNI` | The ISNI system uniquely identifies public identities across multiple fields of creative activity and provides a tool for disambiguating public identities that might otherwise be confused. |
...
| Term | Description |
|------------------------------------|------------------------------------|
| `duration` | The elapsed playing time between the first and last recorded modulations of the recording. [@iso_isrc_2019] |
|  |  |
|  |  |
